	...
	public static void main(String[] args) {
		...
		while (cont.equalsIgnoreCase("y")) {
			...
			case 1:
				...
				PlayerOne rock = new PlayerOne();

				user1.setUserChoice(hPSelection);
				Roshambo p1 = user1.generateRoshambo();
				Roshambo p2 = rock.generateRoshambo();
				System.out.println();
				System.out.println(user1.getName() + ": " + p1);
				System.out.println(rock.getName() + ": " + p2);
				decideWinner(p1, p2);
				break;
			case 2:
				String hPSelection2 = Validator.getString(scan, "Please select ROCK, PAPER, or SCISSORS: ");
				PlayerTwo rp2 = new PlayerTwo();

				user1.setUserChoice(hPSelection2);
				Roshambo p3 = user1.generateRoshambo();
				Roshambo p4 = rp2.generateRoshambo();
				System.out.println();
				System.out.println(user1.getName() + ": " + p3);
